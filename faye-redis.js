...
Engine.prototype = {
  ...
  _newClientId: function() {
    ...
    return Promise.resolve(this._redis.zscore(this._clientsKey, clientId))
      .then((timeout) => {
  ...
  destroyClient: function(clientId, callback, context) {
    return Promise.resolve(this._redis.smembers(this._clientChannelsKey(clientId)))
      .then((channels) => {
  ...
  publish: function(message, channels) {
    ...
    return this._redis.sunion(keys)
      .then((clients) => {
        ...
        return Promise.map(clients, (clientId) => {
            ...
            // this.clientExists(clientId, (exists) => {
  ...
  emptyQueue: function(clientId) {
    ...
    return multi.exec()
      .then((results) => {
        ...
        var messages = jsonMessages.map((json) => { return JSON.parse(json); });
